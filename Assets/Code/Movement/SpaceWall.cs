...
public class SpaceWall : MonoBehaviour {
	...
	void Update () {
        ...
        if (transform.position.x + transsize.x*0.5f < boundary.min.x) {
        ...
        else if (transform.position.x - transsize.x*0.5f > boundary.max.x) {
        ...
        else if (transform.position.y - transsize.y*0.5f > boundary.max.y) {
        ...
        else if (transform.position.y + transsize.y*0.5f < boundary.min.y) {
