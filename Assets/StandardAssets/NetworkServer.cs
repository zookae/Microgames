...
public class NetworkServer : MonoBehaviour {
    ...
    public static string MASTERSERVER_HOSTNAME = null;//null;//"dorothy.cc.gt.atl.ga.us";"127.0.0.1";
	...
	public static string SERVER_GAMETYPENAME = "bullethell parameter tuning";
